        ...
        <div>
            <footer className="bg-gray-900 text-gray-200 mt-12">
                <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    {/* About Section */}
                    <div>
                        <img src={mlogo} className='w-20 rounded-full' alt="" />
                        <p className="text-sm text-gray-400">
                            Join runners from all over the world for an unforgettable experience.
                            Together, we run for health, community, and a better tomorrow.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li><Link to={'/applyMarathon/:id'} className="hover:text-white">Registration</Link></li>
                ...
                <div className="bg-gray-800 text-center py-4 text-sm text-gray-500">
                    © 2025 City Marathon. All rights reserved.
                </div>
            </footer>
        </div>
    );
