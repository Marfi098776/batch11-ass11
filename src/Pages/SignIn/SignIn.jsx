...
const SignIn = () => {
    ...
    return (
        <div className='hero min-h-screen'>
            <div className="w-full max-w-md p-4 rounded-md border-1 border-violet-600 sm:p-8  text-gray-800 ">
                ...
                <form onSubmit={handleSignIn} className="space-y-8">
                    ...
                    <p className="px-6 text-sm text-center text-gray-600">Don't have an account yet?
                        <Link to="/register" rel="noopener noreferrer" className="hover:underline text-violet-600">Register</Link>.
                    </p>
                </form>
            </div>
        </div>
